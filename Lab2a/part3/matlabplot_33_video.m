...
%trace file
[packet_no_p, time_p, frametype, packetsize_p, ua, ub, uc] = textread('movietrace.data', '%f %f %c %f %f %f %f');
time1 = zeros(1,50000);
...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('bucket_video.txt', '%f %f %f %f');
time2 = zeros(1,80000);
...
%sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('TrafficSinkOutput_video.txt', '%f %f %f');
time3 = zeros(1,80000);
