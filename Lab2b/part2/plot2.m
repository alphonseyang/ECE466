...
%trace file
[packet_no_p, time_p, packetsize_p] = textread('ex1_output.txt', '%f %f %f');
...
%sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('ex1_TrafficSinkOutput.txt', '%f %f %f');
