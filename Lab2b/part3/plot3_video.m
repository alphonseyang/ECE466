...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('video2_bucket.txt', '%f %f %f %f');
time_array2 = zeros(1,40000);
cumulative_arrival2 = zeros(1,40000);
...
%sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('video2_TrafficSinkOutput.txt', '%f %f %f');
time_array3 = zeros(1,40000);
cumulative_arrival3 = zeros(1,40000);
...
figure(1);
subplot(1,1,1);
num_of_tokens_to_plot = zeros(1,40000);
back_log_to_plot = zeros(1,40000);
i=1;
while i<=40000
